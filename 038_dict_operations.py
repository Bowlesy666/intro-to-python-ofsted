...
def count_words_by_length(words):
  ...
  for word_length in words:
    if len(word_length) not in word_length_dictionary:
      word_length_dictionary[len(word_length)] = 1
    else:
      word_length_dictionary[len(word_length)] = word_length_dictionary[len(word_length)] + 1
  pass
